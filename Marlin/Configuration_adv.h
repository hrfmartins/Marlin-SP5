 ...
 *   A greater range can be achieved by enabling USE_OCR2A_AS_TOP. But note that this option blocks the use oft
...
#define BEZIER_CURVE_SUPPORT        // Requires ~2666 bytes //Optional Delete...
